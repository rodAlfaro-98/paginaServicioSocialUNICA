...
@section('contenido')
    ...
    <link rel="stylesheet" href="{{URL::asset('css/departamento.css')}}">
        <div class="container-main">
            ...
            @if ($departamento != 'DSA')
                <h6 class="alumnos-departamento">Alumnos de la {{$departamento}} - Rechazados</h6>
            @else
                <div class="col">
            ...
            @endif
                <div class="subcontainer1">
                    ...
                    <div class="contain-excel">
                        ...
                        <button type="button" class="btn-excel" onclick="window.location='{{route("departamento.excel",["tipo"=> "BAJA","departamento" =>$departamento])}}'">Descargar</Button>
                    </div>
                </div>
                <div class="subcontainer2">
                    ...
                    <img src="{{ URL::asset('assets/img/pdf_icon.svg')}}" style="margin-left:15px;width:30px;height:30px;">
                        ...
                        <button type="button" class="btn-pdf" onclick="window.location='{{route("departamento.pdf",["tipo"=> "BAJA","departamento" =>$departamento])}}'">Descargar</Button>
                    </div>
                </div>
        </div>
        <hr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="button-acciones">
                            <button type="button" class="btn-acc btn-sucess btn-alta" onclick="confirmacionNuevaAlta({{$data->numero_cuenta}})">Volver a dar de alta</Button>
                            <button type="button" class="btn-acc btn-info btn-datos-rechazados" onclick="window.location='{{route("departamento.alumno.datos",["num_cuenta" => $data->numero_cuenta])}}'">Datos</button>
                        </div>
                    </td>
                </tr>
            @endforeach
