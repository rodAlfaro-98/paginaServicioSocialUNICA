                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <button type="button" class="btn" style="color:white; background-color: #1D6F42" onclick="window.location='{{route("departamento.excel",["tipo"=> "BAJA","departamento" =>$departamento])}}'" >Descargar</Button>
                                        </div>
                                    </div>
                                </div>    
                            </div>
                            ...
                            <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <button type="button" class="btn" style="color:white; background-color: #F40F02" onclick="window.location='{{route("departamento.pdf",["tipo"=> "BAJA","departamento" =>$departamento])}}'" >Descargar</Button>
                                        </div>
                                    </div>
                                </div>    
                            </div>
